...
<html lang="en">
  <head>
    ...
    .login-container {
        ...
        border-radius: 5px;
        box-shadow: 0px px 6px rgba(0, 0, 0.1);
        padding: 20px;
        width: 350px;
    }
    .navbar-brand{
      ...
      <div class="container text-center">
        ...
        <div class="login-container col-6 p-3 shadow p-3 mb-5 bg-body-tertiary rounded">
            ...
            <!-- <div class="forgot-password mt-2" style="text-decoration: none;">
                <a href="lupa" onclick="forgotPassword()">forgotpassword</a>
            </div> -->
            <div class="forgot-password mt-2" style="text-decoration: none;">
                <a href="registrasi" onclick="registrasi()"><b>Registrasi</b></a>
            </div>
        </div>
